...
namespace GM_BLL
{
    public class Util
    {
        ...
        public static String DTOC(String valor)
        {
            string objValor = null;
            objValor = valor.Substring(6, 4) + valor.Substring(3, 2) + valor.Substring(0, 2);

            return objValor;
        }

        public static String CTOD(String valor)
        {
            string objValor = null;
            objValor = valor.Substring(6, 2) + '/' + valor.Substring(4, 2) + '/' + valor.Substring(0, 4);

            return objValor;
        }

        public static String FDMONTH()
        {
            string objValor = null;
            DateTime primeirodia = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1);
            objValor = primeirodia.ToString();

            return objValor;
        }

        public static String ConvDataAtual(String Datual)
        {
            CultureInfo culture = new CultureInfo("pt-BR");
            DateTime data = DateTime.Now;
            Datual = data.ToString("dd/MM/yyyy", culture);

            return Datual;
        }

        public static String ConvDataDiv(String DatDiv)
        {
            CultureInfo culture = new CultureInfo("pt-BR");
            DatDiv = Convert.ToDateTime(DatDiv).ToString("dd/MM/yyyy", culture);
        ...
        public static string Criptografar(string texto, string strHash)
        {
        ...
        public static string Descriptografar(string texto, string strHash)
        {
            TripleDESCryptoServiceProvider TDC = new TripleDESCryptoServiceProvider();
            MD5CryptoServiceProvider md5 = new MD5CryptoServiceProvider();
        ...
        public static bool ValidaData(string v_data)
        {
            ...
            Match match = regex.Match(v_data);
        ...
        public static bool ValidaSenha(string v_senha)
        {
            ...
            Match match = regex.Match(v_senha);
        ...
        public static bool ValidaDecimal(string v_valor)
        {
            Regex regex = new Regex(@"^\$(\d{1,3}(\,\d{3})*|(\d+))(\.\d{2})?$");

            Match match = regex.Match(v_valor);
